...
|:---:|:---:|
| <img src="docs/screenshots/menu-night.jpg" alt="القائمة الرئيسية بالسمة الليلية: خلفية صحراء ونجوم، أزرار الصوت والسمة والقائمة أعلى الشاشة، وأزرار الأوضاع الخمسة" width="330"> | <img src="docs/screenshots/menu-day.jpg" alt="القائمة الرئيسية بالسمة النهارية: سماء فاتحة وكثبان رملية، بنفس الأوضاع والإحصائيات" width="330"> |
...
<p align="center">
  <img src="docs/screenshots/settings.jpg" alt="الإعدادات: كتم الصوت ومستواه، مفتاح تقليل الحركة والوميض، وقائمة اختصارات لوحة المفاتيح القابلة لإعادة التعيين" width="330">
</p>
<p align="center"><sub>الإعدادات: مستوى الصوت، تقليل الحركة، وإعادة تعيين الاختصارات — والسمة صارت بزر دائم أعلى الشاشة</sub></p>
...
- **سمتان**: ليلي صحراوي / نهاري ساطع، بزر دائم 🌙/☀️ في أعلى الشاشة
...
- **كل شاشة قابلة للتمرير بالكامل** مهما صغر الجهاز — لا محتوى عالق خارج نطاق التمرير
- **تبديل السمة بضغطة واحدة** من زر دائم بدل التنقل داخل الإعدادات، ولون شريط عنوان المتصفح يتبع السمة
